...
export const DEFAULT_CONFIG: KvManagerConfig = {
 ...
 */
export function loadConfig(cwd?: string): KvManagerConfig {
  let userConfig: Partial<KvManagerConfig> = {};
